/****************************************************************************
** Meta object code from reading C++ file 'EditImage.h'
**
...
#include "../task1/EditImage.h"
#include <QtCore/qbytearray.h>
#include <QtCore/qmetatype.h>
#if !defined(Q_MOC_OUTPUT_REVISION)
#error "The header file 'EditImage.h' doesn't include <QObject>."
...
QT_INIT_METAOBJECT const QMetaObject EditImage::staticMetaObject = { {
    &QGraphicsView::staticMetaObject,
    qt_meta_stringdata_EditImage.data,
    qt_meta_data_EditImage,
    qt_static_metacall,
    nullptr,
    nullptr
} };
